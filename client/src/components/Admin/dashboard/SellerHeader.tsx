...
const SellerDashboardHeader = () => {
  ...
  return (
    <>
      <header
        className={
          '"background-neutral-white" background-neutral-white fixed z-50 flex  w-full flex-row justify-center py-8 dark:bg-customDark-900'
        }
      >
        <div className='padding-x-dashboard-estilo1 flex w-full items-center  justify-between align-middle '>
          <Logo />
          <ReactSVG
      ...
      {hamburguerVisible && <HamburgerAdmin options={dashboardNav} manageHamburguer={setHamburguerVisible} />}
    </>
  )
}
