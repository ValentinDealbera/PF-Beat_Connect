...
const AdminCreateBeatForm = forwardRef((props: Props, ref) => {
  ...
  const defaultValues = useAppSelector((state) => state?.admin?.beats?.currentEdtingBeat) || {}
        ...
        <FormRow>
          <FormColumn className='w-full'>
            ...
            <Input
              ...
              defaultValue={mode === 'edit' ? defaultValues?.priceAmount?.toString() : ''}
              type='number'
              onChange={handleInput}
            ...
            {mode === 'edit' && (
              <Input
                ...
                value={mode === 'edit' ? defaultValues?.userCreator?.username : ''}
            ...
            {mode === 'create' && (
              <label htmlFor='userCreator' className='text-sm-medium flex min-w-0 flex-col gap-1'>
                Usuario creador
                <Autocomplete
                  id='userCreator'
