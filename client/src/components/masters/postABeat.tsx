          ...
          <div className='flex h-full flex-col items-center justify-center gap-7 px-4 xs:px-8 sm:px-14 sm:py-10  '>
            <div className='flex flex-col items-center justify-center gap-2'>
              <h4 className='text-titulo2-regular text-center'>
                Convertirte en vendedor de <span className='text-titulo2-semibold text-red-700'>BeatConnect</span> es
                una <span className='text-titulo2-semibold'>excelente idea!</span>
              </h4>
              <p className='text-base-light text-center'>
                ¿Eres productor musical y estás buscando una plataforma en línea para vender tus beats? BeatConnect es
                la solución perfecta para ti. Crea tu propia tienda virtual y vende tus beats fácilmente.
              </p>
            </div>
            <form onSubmit={handleSubmit}>
              <div className='flex w-full flex-col items-center justify-start gap-4'>
                ...
                <div className='flex w-full flex-row items-center justify-start gap-2'>
                  ...
                  <label className='text-base-light'>Acepto los términos y condiciones</label>
                </div>
              </div>
