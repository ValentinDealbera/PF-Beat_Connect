...
interface BeatRightSheetProps {
  children: React.ReactNode
  setIsDropdownOpen: (arg: boolean) => void
  width?: string
}

const BeatRightSheet = ({ children, setIsDropdownOpen, width = 'w-[360px]' }: BeatRightSheetProps) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <div onClick={handleClick} className='fixed left-0 top-0 z-40 h-screen w-screen  bg-black opacity-50' />
      </div>
    </AnimatePresence>
  )
}

export default BeatRightSheet
