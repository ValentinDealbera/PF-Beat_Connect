...
export default function Modal({ visible, setVisible, cartItems }: MiniCartProps) {
          ...
          <div className='flex h-full flex-col justify-between gap-4'>
            ...
            <div className='flex h-full flex-col justify-between gap-4 px-4 xs:px-8 sm:px-9 pt-8'>
              <div className='flex flex-col gap-4'>
                {Array.isArray(cartItems) && cartItems.map((producto) => <MiniCartItem producto={producto.beat} />)}
              </div>
              <div id='total'>
                <Link
                  href='/beats/cart'
