...
const textBoxStyles =
  "text-paragraph1-regular text-base-light text-white lg:w-[75%] ";
const buttonStyles =
  "background-primary-red-700 color-neutral-white w-max rounded-full px-8 py-3 text-sm font-semibold";
...
const HeroText = () => {
  ...
  return (
    <div className="flex w-full flex-col justify-center gap-3">
      ...
      <button className={buttonStyles} onClick={() => router.push("/beats")}>
        {buttonText}
      </button>
    </div>
  );
