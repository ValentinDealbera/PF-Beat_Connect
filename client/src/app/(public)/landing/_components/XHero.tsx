        ...
        <div className='padding-estilo2'>
          <div>
            <h1 className='text-titulo1-regular color-neutral-white mb-2 lg:w-2/3 xl:w-1/2'>
              ...
              <span className=' text-titulo1-bold color-neutral-white'>{t('landing.t2')}</span>
            </h1>
            <p className='text-base-light color-neutral-white w-full lg:w-[60%] mb-5'>{t('landing.t3')}</p>
            <Link href='/'>
