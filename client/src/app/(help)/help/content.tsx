  ...
  return (
    <>
      <div className='gap-estilo1 flex flex-col '>
        <h1 className='text-titulo3-semibold text-red-700 '>{t('helpCenterIndex.t1')}</h1>
        <FaqsGrid mode='user' />
        <div
        ...
        >
          <p className='mt-6 w-full cursor-pointer text-center font-light'>
            {t('helpCenterIndex.t2')} <span className='font-medium text-red-700'>{t('helpCenterIndex.t3')}</span>
          </p>
        </div>
      </div>
