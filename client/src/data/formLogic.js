import { ValidationCreateBeat, ValidationCreateReview, ValidationCreateUser } from '@/components'

export const handleInputChange = (e, fieldsToValidate, setFieldsToValidate, form, setForm) => {
